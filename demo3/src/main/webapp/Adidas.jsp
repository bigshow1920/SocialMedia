      ...
      <div id="1stRange">
          <ul type="none">
                ...
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="Superstar.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/superstar.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="Superstar.jsp" target="_blank">
                        <div id="product-detail-top"> Originals </div>
              ...
              <li>
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="WomanSuperstar.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/woman superstar.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="WomanSuperstar.jsp" target="_blank">
                        <div id="product-detail-top"> Nữ - Originals </div>
                        <div id="product-detail-main">
                          <span id="product-name"> SUPERSTAR </span>
                          <div id="product-price" value=1680000> 1 680 000đ </div>
                        </div>
                ...
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="NMDR1.jsp target="_blank">
                        <img id="product-img" src="images/Adidas/nmd_r1.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="NMDR1.jsp" target="_blank">
                ...
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="UltraboostDNA.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/ultraboost dna cty.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="UltraboostDNA.jsp" target="_blank">
                        <div id="product-detail-top"> Chạy </div>
                        <div id="product-detail-main">
      ...
      <div id="3rdRange">
          <ul type="none">
                ...
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="Ultraboost Summer RDY.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/ultraboost summer.rdy.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="Ultraboost Summer RDY.jsp" target="_blank">
              ...
              <li>
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="Ultra4D.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/ultra4d.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="Ultra4D.jsp" target="_blank">
              ...
              <li>
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="Ultraboost20.jsp." target="_blank">
                        <img id="product-img" src="images/Adidas/ultraboost 20.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="Ultraboost20.jsp" target="_blank">
                        <div id="product-detail-top"> Chạy </div>
                        <div id="product-detail-main">
                          <span id="product-name"> ULTRABOOST 20 </span>
                          <div id="product-price" value=5000000> 5 000 000đ </div>
                        </div>
                      </a>
                    </div>
              ...
              <li>
                <div id="adidas-product-card">
                    <div>
                      <a id="asset-link" href="4Drun10.jsp" target="_blank">
                        <img id="product-img" src="images/Adidas/4d-run-1.0.jpg">
                      </a>
                    </div>
                    <div>
                      <a id="asset-link" href="4Drun10.jsp" target="_blank">
                        <div id="product-detail-top"> Chạy </div>
                        <div id="product-detail-main">
                          <span id="product-name"> 4D RUN 1.0 </span>
                          <div id="product-price" value=5500000> 5 500 000đ </div>
                        </div>
                      </a>
                    </div>
                  </div>  
